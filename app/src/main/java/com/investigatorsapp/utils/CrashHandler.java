...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        if (!handleException(ex) && mDefaultHandler != null) {
            ...
            try {
                ...
                Logger.e(TAG, "uncaughtException sleep exception = " + e.toString());
            }
            // 退出程序
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            Logger.e(TAG, "collectDeviceInfo exception, e = " + e.toString());
        }
    }
...
//        }
        ...
        try {
            ...
            String fileName = time + "_investigate_crash.log";
            ...
            Logger.e(TAG, "saveCrashInfo2File error, e = " + e.toString());
        }
        return null;
    }
